...
## Ограничения
Безопасность нашего программного обеспечения является одной из наших основных целей. Мы оставляем все ограничения установльные производтелем, поскольку они были сделаны не для забавы.
...
Редактирование главного экрана отличается от оригинальной прошивки Joyetech. Чтобы редактировать элементы на главном экране, вызовите действие «редактировать главный экран» (по умолчанию 4 нажатия кнопки Fire). Одиночний щелчок кнопкой Fire переключит на следующий редактируемый элемент. Выбранный элемент редактируется кнопками + / –. Для выхода из режима редактирования удерживайте кнопку Fire около 1 секунды.
...
* **Timeouts**
     - **Dim** - время автоматического гашения экрана;
     - **Dim** :lock: - время автоматического гашения экрана в заблокированном состоянии;
...
* **Stealth** - настройки экрана в стелс режиме:
     ...
     - **ClkOnF** - показывать часы по одному щелчку кнопки Fire, если они включены на главном экране;
...
* **Clicks** - настройка действий на быстрые клики Fire
     * **2/3/4 раза**:
          ...
          - Key Lock - вкл/выкл блокировку кнопок;
